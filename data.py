...
FEATURE_ACTION_TYPES = {
    ...
    # ── Class/subclass/racial limited-use features typed per rules text ──
    # Wizard (PHB p.115-119)
    "arcane recovery":                 ("Special", "Recover spell slots during a short rest"),
    "portent":                         ("Special", "Replace a d20 roll with a foretold roll (2-3/long rest)"),
    "greater portent":                 ("Special", "Roll three d20s for Portent instead of two"),
    "alter memories":                  ("Special", "Alter a charmed creature's memory of your magical influence"),
    "minor alchemy":                   ("Special", "Transform one nonmagical substance into another"),
    "minor conjuration":               ("Action", "Conjure an inanimate object (≤3 ft, ≤10 lb) in your hand"),
    "improved minor illusion":         ("Special", "Create both a sound and an image with minor illusion"),
    "command undead":                  ("Action", "Command an undead within 60 ft (WIS save)"),
    "transmuter's stone":              ("Special", "Bestow a transmuter's stone benefit on a creature"),
    "master transmuter":               ("Action", "Consume transmuter's stone for a transmutation effect"),
    "overchannel":                     ("Special", "Deal maximum damage with a 1st-5th level wizard spell"),
    "signature spell":                 ("Action", "Cast a chosen 3rd-level spell without a slot (2/short rest)"),
    "illusory self":                   ("Reaction", "Interpose an illusory duplicate; the attack misses"),
    "instinctive charm":               ("Reaction", "Divert an attack to another creature within range (WIS save)"),
    "bend luck":                       ("Reaction", "Reaction + 2 SP: add or subtract 1d4 to another creature's roll"),
    # Cleric (PHB p.59-63) + subclass
    "divine intervention":             ("Action", "Call on your deity for aid (percentile roll)"),
    "divine sense":                    ("Action", "Detect celestials, fiends, and undead within 60 ft"),
    "cleansing touch":                 ("Action", "End one spell on yourself or a willing creature you touch"),
    "warding flare":                   ("Reaction", "Impose disadvantage on an attack against you"),
    "improved flare":                  ("Reaction", "Use Warding Flare to protect an ally within 30 ft"),
    "dampen elements":                 ("Reaction", "Grant resistance to acid/cold/fire/lightning/thunder damage"),
    "wrath of the storm":              ("Reaction", "Deal 2d8 lightning/thunder damage to an attacker who hits you"),
    "thunderbolt strike":              ("Special", "Push a Large or smaller creature 10 ft when you deal lightning damage"),
    "corona of light":                 ("Action", "Activate aura of sunlight: enemies have disadvantage on saves"),
    "avatar of battle":                ("Special", "Resistance to bludgeoning/piercing/slashing from nonmagical weapons"),
    "master of nature":                ("Bonus Action", "Command charmed animals/plants on their next turn"),
    "visions of the past":             ("Special", "Meditate 1+ min to glimpse the past of an object or place"),
    "improved duplicity":              ("Action", "Create up to four illusory duplicates (Channel Divinity)"),
    "blessing of the trickster":       ("Action", "Touch a willing creature: advantage on Stealth checks (Channel Divinity)"),
    # Paladin (PHB p.83-89) + subclass
    "holy nimbus":                     ("Action", "Aura of sunlight: 10 radiant damage to enemies in 30 ft"),
    "avenging angel":                  ("Action", "Assume angelic form for 1 hour (flight, aura, fear)"),
    "elder champion":                  ("Action", "Assume form of an ancient force of nature (1 min)"),
    "dread lord":                      ("Action", "Aura of gloom: frightened enemies take 4d10 psychic"),
    # Sorcerer (PHB p.99-105)
    "draconic presence":               ("Action", "Spend 5 SP: aura of awe or fear to 60 ft (1 min)"),
    "dragon wings":                    ("Bonus Action", "Sprout or dismiss draconic wings"),
    "sorcery points":                  ("Special", "Spend sorcery points to fuel metamagic or create slots (pool)"),
    "font of magic":                   ("Special", "Spend sorcery points to fuel metamagic or create slots (pool)"),
    # Warlock (PHB p.105-112)
    "mystic arcanum":                  ("Action", "Cast your chosen arcanum spell once without a spell slot"),
    "eldritch master":                 ("Special", "Entreat patron for 1 min to regain Pact Magic spell slots"),
    "dark one's own luck":             ("Special", "Add a d10 to an ability check or saving throw"),
    "hurl through hell":               ("Special", "On a hit, send target through the lower planes (10d10 psychic)"),
    "fey presence":                    ("Action", "10-ft cube: WIS save or charmed/frightened until your next turn"),
    "misty escape":                    ("Reaction", "When damaged: turn invisible and teleport up to 60 ft"),
    "dark delirium":                   ("Action", "Plunge a creature into an illusory realm (charmed/frightened)"),
    "entropic ward":                   ("Reaction", "Impose disadvantage on an attack against you; boost your next hit"),
    "create thrall":                   ("Action", "Touch an incapacitated humanoid to charm it permanently"),
    # Druid (PHB p.68) / Monk / Fighter pools
    "natural recovery":                ("Special", "Recover spell slots during a short rest (druid)"),
    "ki":                              ("Special", "Spend ki points to fuel monk features (pool)"),
    "combat superiority":              ("Special", "Spend a superiority die on a maneuver (pool)"),
    # Rogue — Arcane Trickster (PHB p.97-98)
    "spell thief":                     ("Reaction", "After a spell targets you, force a save to steal the spell"),
    # Racial traits (PHB/MToM)
    ...
    "reach to the blaze":              ("Action", "Cast burning hands (racial)"),
    "merge with stone":                ("Special", "Racial trait: merge with stone"),
    "mingle with the wind":            ("Special", "Racial trait: mingle with the wind"),
    # ── Runtime-injected LIMITED_USE keys (data_loader: race/subclass/NPC traits) ──
    # Barbarian — Path of the Ancestral Guardian (XGtE p.9-10)
    "ancestral protectors":            ("Special", "While raging, first creature you hit has disadvantage on attacks vs others"),
    "spirit shield":                   ("Reaction", "Reduce damage to an ally within 30 ft by 2d8 (3d8/4d8 at higher level)"),
    "consult the spirits":             ("Special", "Cast augury or clairvoyance by consulting spirits (1/rest)"),
    "vengeful ancestors":              ("Reaction", "When damaged while raging, spirit deals psychic damage to the attacker"),
    # Barbarian — Path of the Zealot (XGtE p.11)
    "fanatical focus":                 ("Special", "While raging, reroll a failed saving throw (once per rage)"),
    # Cleric — Arcana Domain (SCAG p.125)
    "arcane abjuration":               ("Action", "Channel Divinity: banish one celestial, elemental, fey, or fiend (WIS save)"),
    # Cleric — sub-options of Channel Divinity (typed per their own action cost)
    "channel divinity: abjure enemy":  ("Action", "Channel Divinity: denounce one creature (WIS save or frightened)"),
    "channel divinity: guided strike": ("Special", "Channel Divinity: when you make an attack roll, gain +10 to it"),
    "channel divinity: nature's wrath":("Action", "Channel Divinity: spectral vines restrain one creature (STR/DEX save)"),
    "channel divinity: order's demand":("Action", "Channel Divinity: charm creatures that can see/hear you (WIS save)"),
    "channel divinity: preserve life": ("Action", "Channel Divinity: heal up to 5× cleric level among allies within 30 ft"),
    "channel divinity: read thoughts": ("Action", "Channel Divinity: read a creature's thoughts (WIS save)"),
    "channel divinity: touch of death":("Action", "Channel Divinity: melee touch deals necrotic damage (WIS save for half)"),
    "channel divinity: turn the faithless": ("Action", "Channel Divinity: turn fey and fiends within 30 ft (WIS save)"),
    "channel divinity: vow of enmity": ("Bonus Action", "Channel Divinity: advantage on attacks vs one creature for 1 min"),
    "channel divinity: war god's blessing": ("Reaction", "Channel Divinity: give an ally within 30 ft +10 to an attack roll"),
    # Fighter — subclasses
    "archer's eye":                    ("Bonus Action", "Add 1d10 to your next attack/damage roll with a longbow or shortbow"),
    "arcane shot":                     ("Special", "Once per turn, apply an Arcane Shot option to an arrow from the Attack action"),
    "bulwark":                         ("Special", "Extend Indomitable to one ally within 60 ft who also failed the save"),
    "fighting spirit":                 ("Bonus Action", "Advantage on weapon attacks this turn + 5 temp HP"),
    "inspiring surge":                 ("Special", "When you use Action Surge, an ally within 60 ft may attack as a reaction"),
    "rallying cry":                    ("Special", "When you use Second Wind, up to 3 allies within 60 ft regain fighter-level HP"),
    "shadow martyr":                   ("Reaction", "Your echo takes an attack meant for a creature you can see"),
    "strength before death":           ("Reaction", "When reduced to 0 HP, take an extra turn instead of falling unconscious"),
    "unwavering mark":                 ("Special", "Mark a creature you hit: it has disadvantage attacking others"),
    "warding maneuver":                ("Reaction", "Roll 1d8 to add to AC vs an attack on you or an ally within 5 ft"),
    # Wizard — subclasses
    "arcane ward":                     ("Special", "Casting an abjuration spell creates a ward with HP to absorb damage"),
    "bladesong":                       ("Bonus Action", "Start bladesong: +Int AC, +Concentration saves, +10 ft speed (1 min)"),
    "chronal shift":                   ("Reaction", "Force a reroll of an attack/check/save within 60 ft (2/long rest)"),
    "convergent future":               ("Reaction", "Choose to have a roll within 60 ft succeed or fail"),
    "event horizon":                   ("Action", "Gravitational field: creatures that start their turn within 30 ft save or take damage"),
    "hypnotic gaze":                   ("Action", "Enchant one creature within 5 ft (WIS save or charmed/incapacitated)"),
    "the third eye":                   ("Action", "Gain darkvision, see invisibility, or read lips until next rest"),
    "violent attraction":              ("Reaction", "Boost an ally's weapon hit by 1d10 or redirect a damage source"),
    # Bard — colleges (XGtE p.13-19)
    "combat inspiration":              ("Special", "Ally adds Bardic Inspiration die to weapon damage or AC vs an attack"),
    "cutting words":                   ("Reaction", "Subtract Bardic Inspiration die from a creature's attack/check/damage"),
    "enthralling performance":         ("Special", "After 1 min performance, charm audience (WIS save)"),
    "mantle of inspiration":           ("Bonus Action", "Expend Bardic Inspiration: allies gain temp HP + movement"),
    "mantle of majesty":               ("Bonus Action", "Cast command as a bonus action each turn for 1 min"),
    "mantle of whispers":              ("Reaction", "Capture a dying humanoid's shadow to steal its identity"),
    "master's flourish":               ("Special", "Blade Flourish options no longer cost Bardic Inspiration dice"),
    "peerless skill":                  ("Special", "Add Bardic Inspiration die to a failed ability check"),
    "shadow lore":                     ("Action", "Whisper a phrase only one creature hears (WIS save or frightened)"),
    "unbreakable majesty":             ("Bonus Action", "Majestic presence: attackers must save or can't attack you"),
    "words of terror":                 ("Special", "After 1 min conversation, frighten a humanoid (WIS save)"),
    # Paladin — subclasses
    "exalted champion":                ("Action", "Avatar of conquest: resist all damage, extra attack, allies' attacks crit on 19-20"),
    "invincible conqueror":            ("Action", "Become an avatar of conquest for 1 min (resist all damage, extra attack)"),
    "undying sentinel":                ("Special", "When reduced to 0 HP, drop to 1 instead (1/long rest)"),
    # Ranger — subclasses
    "detect portal":                   ("Action", "Sense the closest planar portal within 1 mile"),
    "ethereal step":                   ("Bonus Action", "Cast etherealness, ending at the end of the current turn (1/short rest)"),
    "magic-user's nemesis":            ("Reaction", "When a creature casts/teleports within 60 ft, force WIS save to foil it"),
    "slayer's prey":                   ("Bonus Action", "Designate a quarry: your weapon attacks deal extra 1d6 to it once per turn"),
    # Rogue — subclasses
    "master duelist":                  ("Special", "If you miss with an attack roll, reroll it with advantage (1/short rest)"),
    "unerring eye":                    ("Action", "Sense illusions, shapechangers, and deceptive magic within 30 ft"),
    # Sorcerer — subclasses / bloodlines
    "favored by the gods":             ("Special", "If you fail a save or miss, roll 2d4 and add to the result (1/short rest)"),
    "strength of the grave":           ("Special", "When damage drops you to 0, CHA save (DC 5+damage) to drop to 1 instead"),
    "unearthly recovery":              ("Bonus Action", "When below half HP, regain half your HP maximum (1/long rest)"),
    "wind soul":                       ("Action", "Racial wind magic (e.g. levitate or gust effects)"),
    # Warlock — patrons
    "defy death":                      ("Special", "When reduced to 0 HP, drop to 1 instead (1/long rest)"),
    "indestructible life":             ("Special", "Advantage on death saves; patron can return you from death once per long rest"),
    "master of hexes":                 ("Special", "When you would make a death save, regain half HP and rise instead (1/long rest)"),
    "searing vengeance":               ("Special", "When you would make a death save, regain half HP and rise in radiance (1/long rest)"),
    # Druid — Circle of the Moon / Shepherd
    "elemental wild shape":            ("Action", "Expend two Wild Shape uses to become an elemental"),
    "faithful summons":                ("Special", "When reduced to 0 HP, conjure animals as a 9th-level spell (1/long rest)"),
    "spirit totem":                    ("Bonus Action", "Manifest a spirit aura (bear/eagle/wolf) for 1 min"),
    # Monk
    "tranquility":                     ("Special", "After a long rest, sanctuary effect until your next long rest"),
    # Race traits (Eberron/planar/etc.)
    "feline agility":                  ("Special", "Double your speed for the turn; recharges when you move 0 ft on a turn"),
    "fury of the small":               ("Special", "When you damage a larger creature, deal extra damage equal to your level (1/short rest)"),
    "githyanki psionics":              ("Special", "Cast mage hand, jump, and misty step with this trait"),
    "headwinds":                       ("Action", "Cast gust or gust of wind (racial)"),
    "healing touch":                   ("Action", "Spend one Hit Die to heal yourself or a creature you touch"),
    "hungry jaws":                     ("Bonus Action", "Make a special bite attack that grants temp HP"),
    "imprint prey":                    ("Bonus Action", "Mark one creature as your quarry until it dies"),
    "partially amphibious":            ("Special", "Breathe underwater for up to 1 hour (1/long rest)"),
    "primal connection":               ("Action", "Cast animal friendship (racial)"),
    "radiant consumption":             ("Action", "Radiate searing light for 1 min; damage enemies, heal allies"),
    "radiant soul":                    ("Action", "Grow luminous wings, fly, and gain +2d10 radiant damage on weapon attacks"),
    "relentless endurance":            ("Special", "When reduced to 0 HP, drop to 1 instead (1/long rest)"),
    "saving face":                     ("Special", "If you miss/fail, gain up to +5 bonus equal to allies within 30 ft (1/short rest)"),
    "scribe's insight":                ("Action", "Cast comprehend languages (racial)"),
    "sentinel's shield":               ("Reaction", "Cast shield (racial, recharges on short/long rest)"),
    "shared passage":                  ("Bonus Action", "Teleport up to your walking speed, bringing one willing creature"),
    "slip into shadow":                ("Bonus Action", "Use the Hide action even with no cover (1/short rest)"),
    "stone's endurance":               ("Reaction", "Roll a d12 + Con to reduce damage taken (1/short rest)"),
    "surprise attack":                 ("Special", "First round: advantage and +3d6 damage vs surprised creatures"),
    "wards and seals":                 ("Action", "Cast alarm as a ritual or arcane lock (racial)"),
    # NPC/monster traits
    "change shape":                    ("Action", "Polymorph into a beast/elemental form (monster/NPC trait)"),
    "innate spellcasting":             ("Special", "Cast innate spells (monster/NPC trait)"),
    ...
    # Folded in with Ebon Tides / Margreve / Shadow Fey / the Middle-earth books. Types read from
    # each feature's own text: "As a bonus action…" / "as a reaction…" are explicit; a feature that
    # rides on a hit (Sneak Attack damage, an attack roll) costs no action, so it is Special; and a
    # trait that only grants the ability to cast a spell takes that spell's own casting time.
    "avatar of death":                 ("Bonus Action", "On reducing a target to 0 HP, allies within 30 ft save or are frightened"),
    "avatar of the wood":              ("Action", "Transform into a forest aspect"),
    "bittersweet perfume":             ("Action", "Spend a Wild Shape use: a mind-affecting floral perfume"),
    "black magic":                     ("Bonus Action", "Cast darkness without components (3/long rest)"),
    "blessed chosen":                  ("Reaction", "Protect an ally being attacked within 30 ft"),
    "canopy":                          ("Reaction", "Summon a canopy of leaves that stops a ranged attack"),
    "chinks in the armour":            ("Bonus Action", "Perception check vs the target's AC to make your first hit a crit"),
    "consume darkness":                ("Bonus Action", "While raging in dim light or darkness, regain 1d12 + level HP"),
    "dark servant":                    ("Bonus Action", "Animate a creature's shadow as your servant"),
    "darkness falls":                  ("Action", "Emit a 15-ft sphere of magical darkness that moves with you"),
    "disciplined":                     ("Bonus Action", "Gain advantage on all attack rolls this round"),
    "divine sustenance":               ("Bonus Action", "Allies in your Chew Shadows light regain HP"),
    "duty over death":                 ("Reaction", "Call an ally back from the brink of death"),
    "eagle-feathered arrow":           ("Bonus Action", "Draw and loose a special arrow; a hit crits and knocks the target prone"),
    "fade away":                       ("Action", "While standing still, turn invisible (uses per day = prof bonus)"),
    "fade to black":                   ("Bonus Action", "In dim light or darkness, turn invisible for 1 minute"),
    "fighting fit":                    ("Reaction", "End charmed/frightened/paralyzed/stunned on you or an ally within 30 ft"),
    "focused":                         ("Bonus Action", "Spend a Focus point on a combat manoeuvre"),
    "graceful landing":                ("Special", "Descend 60 ft per round and take no falling damage (passive)"),
    "honey of the bear maiden":        ("Special", "Forage 1d4 servings of blessed honey per day (out of combat)"),
    "intruder's bane":                 ("Bonus Action", "Ward a 15-ft area: intruders take damage"),
    "lingering perfume":               ("Special", "Immune to harmful vapours; advantage against them (passive)"),
    "moon child":                      ("Action", "Cast moonbeam (uses per day = WIS modifier)"),
    "night music":                     ("Reaction", "When you cast a spell, also frighten creatures within 60 ft"),
    "on silent wings":                 ("Action", "Take the Hide action even while visible"),
    "owl’s eyes":                      ("Action", "Cast clairvoyance once, no components"),
    "path of shadows":                 ("Bonus Action", "Cast misty step (uses per day = CHA modifier)"),
    "predatory grace":                 ("Action", "Cast pass without trace without a slot (1/rest)"),
    "rage of the roaring sun":         ("Bonus Action", "Creatures in your Chew Shadows light take radiant damage"),
    "shadow flight":                   ("Action", "Cast etherealness (concentration, up to 1 hour)"),
    "shadow grasp":                    ("Special", "On Sneak Attack damage, force a DEX save or restrain the target"),
    "sickening revenge":               ("Reaction", "When damaged, poison the creature that hurt you"),
    "snake-like speed":                ("Reaction", "Halve the damage of an attack you are aware of"),
    "step into shadow":                ("Bonus Action", "Teleport through shadow to reappear next to an enemy"),
    ...
    "animating performance":          ("Action", "As an action, you can animate one Large or smaller nonmagical item within 30 feet of you that isn't being…"),
    "awakened spellbook":             ("Special", "Using specially prepared inks and ancient incantations passed down by your wizardly order, you have awakened…"),
    "blazing revival":                ("Special", "The bond with your wildfire spirit can save you from death. If the spirit is within 120 feet of you when you…"),
    "bolstering magic":               ("Action", "You can harness your wild magic to bolster yourself or a companion. As an action, you can touch one creature…"),
    "bound magic":                    ("Special", "At 6th level, you begin to master an understanding of elven high magic. You bind magic into the fabric of a…"),
    "bulwark of force":               ("Bonus Action", "You can shield yourself and others with telekinetic force. As a bonus action, you can choose creatures,…"),
    "call the hunt":                  ("Special", "The beast within you grows so powerful that you can spread its ferocity to others and gain resilience from…"),
    "channel divinity: twilight sanctuary":  ("Action", "You can use your Channel Divinity to refresh your allies with soothing twilight. As an action, you present…"),
    "clockwork cavalcade":            ("Action", "You summon spirits of order to expunge disorder around you. As an action, you summon the spirits in a…"),
    "controlled surge":               ("Special", "Whenever you roll on the Wild Magic table, you can roll the die twice and choose which of the two effects to…"),
    "cosmic omen":                    ("Reaction", "Whenever you finish a long rest, you can consult your Star Map for omens. When you do so, roll a die. Until…"),
    "dance of death":                 ("Bonus Action", "Starting at 17th level, as a bonus action you can perform a dance of whirling death that lasts until the end…"),
    "eldritch cannon":                ("Action", "You've learned how to create a magical cannon. Using woodcarver's tools or smith's tools, you can take an…"),
    "elemental gift":                 ("Bonus Action", "You begin to take on characteristics of your patron's kind. You now have resistance to a damage type…"),
    "emboldening bond":               ("Action", "You can forge an empowering bond among people who are at peace with one another. As an action, you choose a…"),
    "eyes of night":                  ("Action", "You can see through the deepest gloom. You have darkvision out to a range of 300 feet. In that radius, you…"),
    "fathomless plunge":              ("Action", "You can magically open temporary conduits to watery destinations. As an action, you can teleport yourself…"),
    "fey reinforcements":             ("Special", "The royal courts of the Feywild have blessed you with the assistance of fey beings: you know summon fey (a…"),
    "frost rune":                     ("Bonus Action", "This rune's magic evokes the might of those who survive in the wintry wilderness, such as frost giants.…"),
    "genie's vessel":                 ("Action", "Your patron gifts you a magical vessel that grants you a measure of the genie's power. The vessel is a Tiny…"),
    "glorious defense":               ("Reaction", "You can turn defense into a sudden strike. When you or another creature you can see within 10 feet of you is…"),
    "grasping tentacles":             ("Special", "You learn the spell Evard's black tentacles. It counts as a warlock spell for you, but it doesn't count…"),
    "hand of ultimate mercy":         ("Action", "Your mastery of life energy opens the door to the ultimate mercy. As an action, you can touch the corpse of…"),
    "high magic":                     ("Special", "Starting at 14th level, ritual versions of spells that you cast are treated as if they were cast using a…"),
    "hill rune":                      ("Bonus Action", "This rune's magic bestows a resilience reminiscent of a hill giant. While wearing or carrying an object that…"),
    "infectious fury":                ("Reaction", "When you hit a creature with your natural weapons while you are raging, the beast within you can curse your…"),
    "infectious inspiration":         ("Reaction", "When you successfully inspire someone, the power of your eloquence can now spread to someone else. When a…"),
    "ki points":                      ("Special", "Keerthi has 2 ki points that she regains when she takes a short or long rest. These points power her martial…"),
    "limited wish":                   ("Action", "You entreat your patron to grant you a small wish. As an action, you can speak your desire to your Genie's…"),
    "living legend":                  ("Bonus Action", "You can empower yourself with the legends—whether true or exaggerated—of your great deeds. As a bonus…"),
    "magic awareness":                ("Action", "As an action, you can open your awareness to the presence of concentrated magic. Until the end of your next…"),
    "manifest mind":                  ("Bonus Action", "You can conjure forth the mind of your Awakened Spellbook. As a bonus action while the book is on your…"),
    "mortal bulwark":                 ("Bonus Action", "You manifest a spark of divine power in defense of the mortal realms. As a bonus action, you gain the…"),
    "one with the word":              ("Reaction", "Your connection to your Awakened Spellbook has become so profound that your soul has become entwined with…"),
    "parry":                          ("Reaction", "At 7th level you may use your reaction to add your proficiency bonus to your AC against one melee attack…"),
    "performance of creation":        ("Action", "As an action, you can channel the magic of the Song of Creation to create one nonmagical item of your choice…"),
    "primal awareness":               ("Special", "3rd-level ranger feature, which replaces the Primeval Awareness feature You can focus your awareness through…"),
    "psychic veil":                   ("Action", "You can weave a veil of psychic static to mask yourself. As an action, you can magically become invisible,…"),
    "rend mind":                      ("Special", "You can sweep your Psychic Blades directly through a creature's mind. When you use your Psychic Blades to…"),
    "ritual focus":                   ("Special", "Starting at 2nd level, you can spend 10 minutes centering your mental energy and creating a ritual focus.…"),
    "situational awareness: impromptu ambush":  ("Action", "At 15th level, your experience and training coalesce into a state of heightened situational awareness. As an…"),
    "situational awareness: master ambusher":  ("Action", "Starting at 17th level, as an action you can expend your situational awareness to access the battlefield,…"),
    "star map":                       ("Special", "You've created a star chart as part of your heavenly studies. It is a Tiny object and can serve as a…"),
    "starry form":                    ("Bonus Action", "As a bonus action, you can expend a use of your Wild Shape feature to take on a starry form, rather than…"),
    "steps of night":                 ("Bonus Action", "You can draw on the mystical power of night to rise into the air. As a bonus action when you are in dim…"),
    "stone rune":                     ("Reaction", "This rune's magic channels the judiciousness associated with stone giants. While wearing or carrying an…"),
    "storm rune":                     ("Bonus Action", "Using this rune, you can glimpse the future like a storm giant seer. While wearing or carrying an object…"),
    "summon wildfire spirit":         ("Action", "You can summon the primal spirit bound to your soul. As an action, you can expend one use of your Wild Shape…"),
    "telekinetic master":             ("Bonus Action", "Your ability to move creatures and objects with your mind is matched by few. You can cast the telekinesis…"),
    "touch of zymurgy":               ("Action", "By 14th level, you have learned to better direct the 'strange air' both within you and without. You can use…"),
    "trance of order":                ("Bonus Action", "You gain the ability to align your consciousness to the endless calculations of Mechanus. As a bonus action,…"),
    "universal speech":               ("Action", "You gain the ability to make your speech intelligible to any creature. As an action, choose one or more…"),
    "unstable backlash":              ("Reaction", "When you are imperiled during your rage, the magic within you can lash out; immediately after you take…"),
    "wails from the grave":           ("Special", "As you nudge someone closer to the grave, you can channel the power of death to harm someone else as well.…"),
