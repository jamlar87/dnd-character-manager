...
RICH_RACE_DESCS: dict[str, str] = {
    ...
    "Tortle": (
        ...
        "well-lived.\n\n"
        "Mechanically, Monsters of the Multiverse lets a tortle raise one score by 2 and a different "
        "score by 1, or three different scores by 1 (the classic spread was +2 Strength, +1 Wisdom). "
        "Natural Armor gives them a flat AC 17 "
        ...
        "in one skill of their choice (Animal Handling, Medicine, Nature, Perception, Stealth or "
        "Survival). They speak Aquan and Common."
    ),
    "Triton": (
