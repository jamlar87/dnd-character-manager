...
RICH_RACE_DESCS: dict[str, str] = {
    ...
    "Tortle": (
        ...
        "deal 1d4 + Strength slashing damage on an unarmed strike. Survival Instinct grants proficiency "
        "in the Survival skill. They speak Aquan and Common."
    ),
    "Triton": (
...
_TRAIT_DICE = {
    ...
    "Tortle::Claws": "1d4 + Str",     # Tortle — The Tortle Package p.4
