...
def _get_source_slug_map() -> dict[str, dict]:
    ...
    if _source_slug_cache is None:
        ...
        _chapter_aliases = {
            ...
            "chapter 7 i treasure": {"slug": "DMG", "display": "Dungeon Master's Guide (Chapter 7: Treasure)"},
            "chapter 7 | treasure": {"slug": "DMG", "display": "Dungeon Master's Guide (Chapter 7: Treasure)"},
            "chapter 7 / treasure": {"slug": "DMG", "display": "Dungeon Master's Guide (Chapter 7: Treasure)"},
            "chapter 7 i treasure . 224": {"slug": "DMG", "display": "Dungeon Master's Guide (Chapter 7: Treasure)"},
            "chapter 3": {"slug": "DMG", "display": "Dungeon Master's Guide (Chapter 3)"},
            "chapter 3 | spells": {"slug": "PHB", "display": "Player's Handbook (Chapter 3: Spells)"},
            "chapter 3 magical miscellany": {"slug": "DTCOE", "display": "Tasha's Cauldron of Everything (Chapter 3: Magical Miscellany)"},
            "chapter 3 | magical miscellany": {"slug": "DTCOE", "display": "Tasha's Cauldron of Everything (Chapter 3: Magical Miscellany)"},
            "chapter 4 | dungeon master's tools": {"slug": "DMG", "display": "Dungeon Master's Guide (Chapter 4: DM's Tools)"},
            "chapter 4: creating adventures": {"slug": "DMG", "display": "Dungeon Master's Guide (Chapter 4: Creating Adventures)"},
            "chapter 2 | dungeon master's tools": {"slug": "DMG", "display": "Dungeon Master's Guide (Chapter 2: DM's Tools)"},
            "chapter 2 dungeon master's tools": {"slug": "DMG", "display": "Dungeon Master's Guide (Chapter 2: DM's Tools)"},
            "chapter 2, the land of chult": {"slug": "ToA", "display": "Tomb of Annihilation (The Land of Chult)"},
            "chapter 6, hell of a summer": {"slug": "BGDIA", "display": "Baldur's Gate: Descent into Avernus (Chapter 6)"},
            "appendix d monsters and npcs": {"slug": "ToA", "display": "Tomb of Annihilation (Appendix D: Monsters and NPCs)"},
            "appendix d": {"slug": "ToA", "display": "Tomb of Annihilation (Appendix D)"},
            "appendix d p.": {"slug": "ToA", "display": "Tomb of Annihilation (Appendix D)"},
            "appendix d | monsters and npcs": {"slug": "ToA", "display": "Tomb of Annihilation (Appendix D: Monsters and NPCs)"},
            "appendix d: monsters and npcs": {"slug": "ToA", "display": "Tomb of Annihilation (Appendix D: Monsters and NPCs)"},
            "appendix a | monsters & npcs": {"slug": "MTF", "display": "Mordenkainen's Tome of Foes (Appendix A: Monsters & NPCs)"},
