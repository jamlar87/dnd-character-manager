...
_FIREARM_ITEMS = [
    # Renaissance
    {"name":"Pistol","type":"Martial Ranged Weapon (Renaissance)","description":"1d10 piercing — Ammunition (30/90), loading. Loading: you can fire only one piece of ammunition per action, bonus action, or reaction, regardless of your number of attacks. (DMG p.267)","cost":"250 gp","weight":3,"rarity":"","source":"DMG 2014"},
    {"name":"Musket","type":"Martial Ranged Weapon (Renaissance)","description":"1d12 piercing — Ammunition (40/120), loading, two-handed. Loading: you can fire only one piece of ammunition per action, bonus action, or reaction, regardless of your number of attacks. (DMG p.267)","cost":"500 gp","weight":10,"rarity":"","source":"DMG 2014"},
    ...
    # Modern
    {"name":"Pistol, automatic","type":"Martial Ranged Weapon (Modern)","description":"2d6 piercing — Ammunition (50/150), reload (15 shots). Reload: after 15 shots, use an action or bonus action to reload the magazine. (DMG p.267)","cost":"—","weight":3,"rarity":"","source":"DMG 2014","charges":15,"charge_recharge":"reload (action or bonus action)"},
    {"name":"Revolver","type":"Martial Ranged Weapon (Modern)","description":"2d8 piercing — Ammunition (40/120), reload (6 shots). Reload: after 6 shots, use an action or bonus action to reload all six chambers. (DMG p.267)","cost":"—","weight":3,"rarity":"","source":"DMG 2014","charges":6,"charge_recharge":"reload (action or bonus action)"},
    {"name":"Rifle, hunting","type":"Martial Ranged Weapon (Modern)","description":"2d10 piercing — Ammunition (80/240), reload (5 shots), two-handed. Reload: after 5 shots, use an action or bonus action to reload the internal magazine. (DMG p.267)","cost":"—","weight":8,"rarity":"","source":"DMG 2014","charges":5,"charge_recharge":"reload (action or bonus action)"},
    {"name":"Rifle, automatic","type":"Martial Ranged Weapon (Modern)","description":"2d8 piercing — Ammunition (80/240), burst fire, reload (30 shots), two-handed. Burst Fire: spend 10 shots to force every creature in a 10-ft cube within range to make a DC 15 DEX save, taking the weapon's damage on a failure (no damage on success). Reload: after 30 shots, use an action or bonus action to reload. (DMG p.267)","cost":"—","weight":8,"rarity":"","source":"DMG 2014","charges":30,"charge_recharge":"reload (action or bonus action)"},
    {"name":"Shotgun","type":"Martial Ranged Weapon (Modern)","description":"2d8 piercing — Ammunition (30/90), reload (2 shots), two-handed. Reload: after 2 shots, use an action or bonus action to reload both barrels. (DMG p.267)","cost":"—","weight":7,"rarity":"","source":"DMG 2014","charges":2,"charge_recharge":"reload (action or bonus action)"},
    # Futuristic
    {"name":"Laser pistol","type":"Martial Ranged Weapon (Futuristic)","description":"3d6 radiant — Ammunition (40/120), reload (50 shots). Reload: after 50 shots, use an action or bonus action to swap the energy cell. Radiant damage bypasses some resistances. (DMG p.268)","cost":"—","weight":2,"rarity":"","source":"DMG 2014","charges":50,"charge_recharge":"reload (action or bonus action)"},
    {"name":"Antimatter rifle","type":"Martial Ranged Weapon (Futuristic)","description":"6d8 necrotic — Ammunition (120/360), reload (2 shots), two-handed. Reload: after 2 shots, use an action or bonus action to swap the energy cell. Necrotic damage withers flesh and ignores some defenses. Highest single-shot damage of any weapon. (DMG p.268)","cost":"—","weight":10,"rarity":"","source":"DMG 2014","charges":2,"charge_recharge":"reload (action or bonus action)"},
    {"name":"Laser rifle","type":"Martial Ranged Weapon (Futuristic)","description":"3d8 radiant — Ammunition (100/300), reload (30 shots), two-handed. Reload: after 30 shots, use an action or bonus action to swap the energy cell. Radiant damage bypasses some resistances. (DMG p.268)","cost":"—","weight":7,"rarity":"","source":"DMG 2014","charges":30,"charge_recharge":"reload (action or bonus action)"},
    ...
    {"name":"Gunpowder, powder horn","type":"Explosive","description":"A water-resistant horn of gunpowder. Set fire to cause 3d6 fire damage in 10 ft (DC 12 DEX half). One ounce flares for 1 round.","cost":"35 gp","weight":2,"rarity":"","source":"DMG 2014"},
    {"name":"Gunpowder, keg","type":"Explosive","description":"A small wooden keg of gunpowder. Set fire to cause 7d6 fire damage in 10 ft (DC 12 DEX half).","cost":"250 gp","weight":20,"rarity":"","source":"DMG 2014"},
    {"name":"Dynamite (stick)","type":"Explosive","description":"As an action, light and throw up to 60 ft. Explodes at the start of your next turn. DC 12 DEX save; 3d6 bludgeoning damage in 5 ft, half on success.","cost":"—","weight":1,"rarity":"","source":"DMG 2014"},
    {"name":"Grenade, fragmentation","type":"Explosive","description":"As an action, throw up to 60 ft. DC 15 DEX save; 5d6 piercing damage in 20-ft radius, half on success.","cost":"—","weight":1,"rarity":"","source":"DMG 2014"},
    {"name":"Grenade, smoke","type":"Explosive","description":"As an action, throw up to 60 ft. Heavily obscures a 20-ft radius for 1 minute.","cost":"—","weight":2,"rarity":"","source":"DMG 2014"},
    {"name":"Grenade launcher","type":"Martial Ranged Weapon (Modern)","description":"Launches fragmentation grenades (range 120 ft). Uses the fragmentation grenade's DC 15 DEX save and 5d6 piercing damage in a 20-ft radius. Requires a fragmentation grenade as ammunition — one shot per grenade. (DMG p.268)","cost":"—","weight":7,"rarity":"","source":"DMG 2014"},
]
...
RACES = {
    "Dwarf": {"subraces": ["Hill Dwarf", "Mountain Dwarf", "Duergar", "Gold Dwarf"], "asi": {"constitution": 2}, "speed": 25, "darkvision": 60, "languages": ["Common", "Dwarvish"], "traits": ["Dwarven Resilience", "Stonecunning"], "desc": "Stout and hardy, standing 4–5 feet tall. Dwarves are known for their skill in battle, resistance to poison, and expertise with stonework. They live in great mountain kingdoms and value tradition and craftsmanship.", "subrace_descs": {"Hill Dwarf": "+1 Wisdom. Dwarven Toughness grants +1 HP per level. The hardier, wiser dwarf subrace.", "Mountain Dwarf": "+2 Strength. Dwarven Armor Training grants light and medium armor proficiency. The stronger, more martial dwarf.", "Duergar": "+1 Strength. Superior Darkvision (120ft), Duergar Resilience (advantage vs illusions/charms/paralysis), Duergar Magic (enlarge/reduce + invisibility at L3/5), Sunlight Sensitivity. The gray dwarves of the Underdark.", "Gold Dwarf": "+1 Wisdom. The southern dwarves of Faerûn — confident, well-adapted to warm climates, with a proud mercantile tradition."}},
    "Elf": {"subraces": ["High Elf", "Wood Elf", "Dark Elf (Drow)", "Sea Elf", "Eladrin", "Shadar-kai"], "asi": {"dexterity": 2}, "speed": 30, "darkvision": 60, "languages": ["Common", "Elvish"], "traits": ["Keen Senses", "Fey Ancestry", "Trance"], "desc": "Graceful and long-lived, elves stand 5–6 feet tall with pointed ears. They are known for their keen senses, immunity to magical sleep, and trance-like meditation instead of sleep.", "subrace_descs": {"High Elf": "+1 Intelligence. Gain a wizard cantrip and an extra language. The most magical of the elves.", "Wood Elf": "+1 Wisdom. Fleet of Foot (+5ft speed) and Mask of the Wild (hide in light natural obscurement). The swift and stealthy elf.", "Dark Elf (Drow)": "+1 Charisma. Superior Darkvision (120ft), Sunlight Sensitivity, and Drow Magic (dancing lights, faerie fire, darkness).", "Sea Elf": "+1 Constitution. Swim speed 30ft, amphibious, and Sea Elf Training (spear, trident, light crossbow, net). The ocean-dwelling elves.", "Eladrin": "+1 Intelligence. Fey Step (misty step 1/short rest). Elves of the Feywild who shift between seasons — spring, summer, autumn, winter.", "Shadar-kai": "+1 Constitution. Necrotic resistance, Blessing of the Raven Queen (teleport 1/long rest, ghostly damage resistance at L3+). Shadow-touched elves serving the Raven Queen."}},
    "Halfling": {"subraces": ["Lightfoot Halfling", "Stout Halfling", "Ghostwise Halfling"], "asi": {"dexterity": 2}, "speed": 25, "darkvision": 0, "languages": ["Common", "Halfling"], "traits": ["Lucky", "Brave", "Halfling Nimbleness"], "desc": "Small and nimble, standing about 3 feet tall. Halflings are famously lucky, brave despite their size, and able to move through the spaces of larger creatures.", "subrace_descs": {"Lightfoot Halfling": "+1 Charisma. Naturally Stealthy lets you hide behind larger creatures. The charming, sneaky halfling.", "Stout Halfling": "+1 Constitution. Stout Resilience grants advantage on poison saves and poison resistance. Also known as Strongheart halflings in the Forgotten Realms. The durable halfling.", "Ghostwise Halfling": "+1 Wisdom. Silent Speech (telepathy 30ft with creatures that share a language). Reclusive, nature-connected halflings of the Chondalwood."}},
    ...
    "Gnome": {"subraces": ["Forest Gnome", "Rock Gnome", "Deep Gnome"], "asi": {"intelligence": 2}, "speed": 25, "darkvision": 60, "languages": ["Common", "Gnomish"], "traits": ["Gnome Cunning"], "desc": "Small and clever, gnomes stand 3–4 feet tall. Known for their intellect, cunning against magic, and natural gift for invention or illusion.", "subrace_descs": {"Forest Gnome": "+1 Dexterity. Natural Illusionist grants a minor illusion cantrip. Speak with Small Beasts. The woodland trickster.", "Rock Gnome": "+1 Constitution. Artificer's Lore doubles proficiency on History checks for magical/tech items. Tinker lets you build tiny clockwork devices.", "Deep Gnome": "+1 Dexterity. Superior Darkvision (120ft), Stone Camouflage (advantage on Stealth in rocky terrain). The svirfneblin — secretive gnomes of the Underdark."}},
