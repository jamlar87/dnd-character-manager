...
def _get_source_slug_map() -> dict[str, dict]:
    ...
    if _source_slug_cache is None:
        ...
        _chapter_aliases = {
            ...
            "chapter 2 | dungeon master's tools": {"slug": "DMG", "display": "Chapter 2 | Dungeon Master's Tools — Dungeon Master's Guide"},
            "chapter 2 dungeon master's tools": {"slug": "DMG", "display": "Chapter 2 Dungeon Master's Tools — Dungeon Master's Guide"},
            "dungeon master's tools p.?": {"slug": "DMG", "display": "Dungeon Master's Tools — Dungeon Master's Guide"},
