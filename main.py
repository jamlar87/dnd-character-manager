...
CLASSES = {
    ...
    "Slayer": {"hd": 12, "skills": ["Animal Handling","Athletics","Intimidation","Perception","Survival"], "skill_count": 2, "saves": ["strength","constitution"], "subclasses": [], "subclass_descs": {}, "desc": "The Slayer fights with raw ferocity — equivalent to a Barbarian.", "weapons": "All", "armor": "Light, medium, shields", "tools": ""},
    "Warden": {"hd": 10, "skills": ["Athletics","Insight","Investigation","Medicine","Persuasion","Survival"], "skill_count": 2, "saves": ["wisdom","charisma"], "subclasses": [], "subclass_descs": {}, "desc": "The Warden is a stalwart defender and leader — akin to a Paladin.", "weapons": "All", "armor": "All, shields", "tools": ""},
    "Warrior": {"hd": 10, "skills": ["Acrobatics","Animal Handling","Athletics","History","Insight","Intimidation","Perception","Survival"], "skill_count": 2, "saves": ["strength","constitution"], "subclasses": [], "subclass_descs": {}, "desc": "The Warrior is a master of arms — equivalent to a Fighter.", "weapons": "All", "armor": "All, shields", "tools": ""},
    "Scholar": {"hd": 6, "skills": ["Arcana","History","Insight","Investigation","Medicine","Nature","Religion"], "skill_count": 3, "saves": ["intelligence","wisdom"], "subclasses": [], "subclass_descs": {}, "desc": "The Scholar masters ancient lore and healing — akin to a Cleric.", "weapons": "Simple", "armor": "Light", "tools": ""},
    "Treasure Hunter": {"hd": 8, "skills": ["Acrobatics","Deception","Insight","Investigation","Perception","Sleight of Hand","Stealth"], "skill_count": 4, "saves": ["dexterity","intelligence"], "subclasses": [], "subclass_descs": {}, "desc": "The Treasure Hunter is a cunning explorer — equivalent to a Rogue.", "weapons": "Simple, hand crossbows, longswords, rapiers, shortswords", "armor": "Light", "tools": "Thieves' tools"},
    "Wanderer": {"hd": 10, "skills": ["Animal Handling","Athletics","Insight","Investigation","Nature","Perception","Stealth","Survival"], "skill_count": 3, "saves": ["strength","dexterity"], "subclasses": [], "subclass_descs": {}, "desc": "The Wanderer is a wilderness expert — equivalent to a Ranger.", "weapons": "All", "armor": "Light, medium, shields", "tools": ""},
}
